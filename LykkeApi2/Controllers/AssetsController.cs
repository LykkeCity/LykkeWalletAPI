...
namespace LykkeApi2.Controllers
{
    ...
    public class AssetsController : Controller
    {
        ...
        {
            var extendedInfo = await _assetsService.AssetExtendedInfoGetAsync(assetId) ?? await _assetsService.AssetExtendedInfoGetDefaultAsync();
