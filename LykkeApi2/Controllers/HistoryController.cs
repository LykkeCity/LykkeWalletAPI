...
namespace LykkeApi2.Controllers
{
    ...
    public class HistoryController : Controller
    {
        ...
        /// </summary>
        /// <param name="operationTypes">The types of the operation, possible values: CashIn, CashOut, Trade, LimitTrade, LimitTradeEvent</param>
            ...
            [FromQuery] int skip)
        {
            ...
            var response = await _operationsHistoryClient.GetByClientId(clientId, operationTypes, assetId, assetPairId, take, skip);
        ...
        /// <param name="operationTypes">The type of the operation, possible values: CashIn, CashOut, Trade, LimitTrade, LimitTradeEvent</param>
        /// <param name="assetId">Asset identifier</param>
        /// <param name="assetPairId">Asset pair identifier</param>
        /// <param name="take">How many maximum items have to be returned</param>
        /// <param name="skip">How many items skip before returning</param>
            ...
            [FromQuery] int skip)
        {
            ...
            var response = await _operationsHistoryClient.GetByWalletId(walletId, operationTypes, assetId, assetPairId, take, skip);
