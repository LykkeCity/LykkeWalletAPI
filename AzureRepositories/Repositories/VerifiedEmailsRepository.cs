...
namespace AzureRepositories.Repositories
{
    public class VerifiedEmailsRepository : IVerifiedEmailsRepository
    {
        ...
        public static VerifiedEmailsRepository CreateVerifiedEmailsRepository(string connString, ILog log)
        {
            return new VerifiedEmailsRepository(new AzureTableStorage<VerifiedEmailEntity>(connString, "VerifiedEmails", log));
        }
    }
}
